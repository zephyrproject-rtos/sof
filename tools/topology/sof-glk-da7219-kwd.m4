#
ifelse(PLATFORM, `bxt', `# Topology for GeminiLake with Dialog7219+Maxim98357a.', `')
...
PIPELINE_PCM_ADD(sof/pipe-SSP_PIPE_NAME-playback.m4,
	1, 0, 2, s32le,
	1000, 0, 0,
	48000, 48000, 48000)
...
DAI_CONFIG(SSP, 1, 0, SSP1-Codec,
        SSP_CONFIG(I2S, SSP_CLOCK(mclk, SSP_MCLK_RATE, codec_mclk_in),
                SSP_CLOCK(bclk, SSP1_BCLK_RATE, codec_slave),
                SSP_CLOCK(fsync, SSP_LRCLK_RATE, codec_slave),
                SSP_TDM(2, TDM_WIDTH, 3, 3),
                SSP_CONFIG_DATA(SSP, 1, SSP1_VALID_BITS, MCLK_ID)))

DAI_CONFIG(SSP, SSP_INDEX, 1, SSP_NAME,
        SSP_CONFIG(I2S, SSP_CLOCK(mclk, SSP_MCLK_RATE, codec_mclk_in),
                SSP_CLOCK(bclk, SSP_BCLK_RATE, codec_slave),
                SSP_CLOCK(fsync, SSP_LRCLK_RATE, codec_slave),
